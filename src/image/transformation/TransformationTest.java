...
public class TransformationTest {
	...
	public static void main(String[] args) {
		...
		tf.processing("F:\\image processing\\transformation\\images4.jpg",
				"F:\\image processing\\transformation\\FFT.jpg", "jpg");
		// 二维Complex型
		Complex[][] complexs = {
				{ new Complex(0, 0), new Complex(1, 0), new Complex(0, 0),
						new Complex(2, 0), },
				{ new Complex(0, 0), new Complex(3, 0), new Complex(0, 0),
						new Complex(4, 0), },
				{ new Complex(0, 0), new Complex(5, 0), new Complex(0, 0),
						new Complex(6, 0), },
				{ new Complex(0, 0), new Complex(7, 0), new Complex(0, 0),
						new Complex(8, 0), } };
