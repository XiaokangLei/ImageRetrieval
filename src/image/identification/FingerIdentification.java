...
public abstract class FingerIdentification implements Identification {
	...
	/*
	 * @Override public String getCharacteristic2(Object target) { // TODO
	 ...
	 * "F:\\image processing\\测试图片素材\\测试图片7\\Timages.jpg"; String str2 =
	 * "F:\\image processing\\测试图片素材\\测试图片7\\images"; int n = 46;
	 * FingerIdentification ident = new PHash(); //searchImage(n, str1, str2,
	 * ident);
	 * 
	 * BufferedImage img =
	 * ImageDigital.readImg("F:\\image processing\\蓝点五壮士儿狼牙山留念.png");
