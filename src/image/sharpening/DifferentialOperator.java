...
//import com.action.FileUpLoadAction;

public class DifferentialOperator {
	private Sharpening sharp = null;

	/*
	 * public static final int HORIZON = 1; public static final int VERTICAL =
	 * 2; public static final int ROBERTS = 3; public static final int SOBEL =
	 * 4; public static final int LAPLACIAN = 5;
	 */
	public DifferentialOperator(int type) {
		/*
		 * switch (type) { case HORIZON: int[] template = {1,2,1, 0,0,0,
		 * -1,-2,-1}; sharp = new FirstOrder(template); break; case VERTICAL:
		 * int[] template2 = {1,2,1, 0,0,0, -1,-2,-1}; sharp = new
		 * FirstOrder(template2); break; case ROBERTS: break; case SOBEL: break;
	...
	public static void main(String args[]) {
		// UploadFileAction path = new UploadFileAction();
		// String FileFileName = path.getUploadFileName();
