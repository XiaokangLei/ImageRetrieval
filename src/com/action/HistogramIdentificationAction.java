...
import image.identification.HistogramIdentification;
...
public class HistogramIdentificationAction extends ActionSupport {
	...
	public String HistogramIdentification() throws Exception {
		...
		for (i = 0; i < tempList.length; i++) {
			if (tempList[i].isFile()) {
				...
				samelist.add(image.identification.HistogramIdentification
						.histogramIditification(histR, tempList[i].toString()));
	...
	public String HistogramIdentification2() throws Exception {
		// 获取CLASSPATH路径,得到项目下webroot/
		String realpath1 = ServletActionContext.getServletContext()
				.getRealPath("/images");
		// 创建file对象 realpath文件夹
		...
		for (i = 0; i < tempList.length; i++) {
			if (tempList[i].isFile()) {
				// System.out.print("文     件：" + tempList[i]);
				samelist.add(image.identification.HistogramIdentification
						.histogramIditification2(src, tempList[i].toString()));
				map.put(samelist.get(i), tempList[i].toString());
			}
		}
		Set<Double> key1 = map.keySet();
	...
	public String HistogramIdentification3() throws Exception {
		// 获取CLASSPATH路径,得到项目下webroot/
		String realpath1 = ServletActionContext.getServletContext()
				.getRealPath("/images");
		// 创建file对象 realpath文件夹
		...
		for (i = 0; i < tempList.length; i++) {
			if (tempList[i].isFile()) {
				// System.out.print("文     件：" + tempList[i]);
				samelist.add(image.identification.HistogramIdentification
						.GetSimilarity3(histR3, tempList[i].toString()));
				map.put(samelist.get(i), tempList[i].toString());
			}
		}
		Set<Double> key1 = map.keySet();
	...
	public String HistogramIdentification4() throws Exception {
		// 获取CLASSPATH路径,得到项目下webroot/
		String realpath1 = ServletActionContext.getServletContext()
				.getRealPath("/images");
		// 创建file对象 realpath文件夹
		...
		for (i = 0; i < tempList.length; i++) {
			if (tempList[i].isFile()) {
				// System.out.print("文     件：" + tempList[i]);
				samelist.add(image.identification.HistogramIdentification
						.GetSimilarity1(histR, tempList[i].toString()));
				map.put(samelist.get(i), tempList[i].toString());
			}
		}
		Set<Double> key1 = map.keySet();
